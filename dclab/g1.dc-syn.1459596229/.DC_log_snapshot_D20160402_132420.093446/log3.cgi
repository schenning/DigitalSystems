...
#        def __cmp__(self,o):
        def __lt__(self,o):
            ...
            return self.lineNumber < o.lineNumber
...
# End Fix for python 3
    ...
    def run():
        ...
        for type in types:
            ...
            for tag,count in summaryCounts[type].items():
        ...
        for type in types:
            print("<td>")
            tags = list(summaryCounts[type].keys())
            tags.sort()
            for tag in tags:
